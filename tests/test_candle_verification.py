...
async def verify_candles():
    ...
    for strike in target_strikes:
        ...
        # Find CE and PE
        ce_contract = next((c for c in contracts if c['strike_price'] == strike and c['instrument_type'] == 'CE'), None)
        pe_contract = next((c for c in contracts if c['strike_price'] == strike and c['instrument_type'] == 'PE'), None)
