...
class DashboardState:
    ...
    async def search_instruments(self, category: str, query_text: str = "") -> List[str]:
    ...
    def _search_instruments_sync(self, category: str, query_text: str) -> List[str]:
        try:
            ...
            if category == 'NSE_EQ':
                ...
                base_query = "SELECT DISTINCT underlying_symbol FROM derivatives_metadata"
            ...
            if query_text:
                ...
                params.append(f"{query_text.upper()}%") # Prefix search is faster and more useful
