...
class DatabaseValidator:
    ...
    def _apply_constraints(self):
        ...
        rules = [
            ...
            (
                ...
                "status",
                "ENUM",
                "PENDING,COMPLETE,CANCELLED,REJECTED",
            ...
            (
                ...
                "NON_NEGATIVE",
                None,
                "Holdings quantity cannot be negative",
            ),
            (
                "holdings",
                "average_price",
    ...
    def validate_holding(
        self, holding_data: Dict[str, Any]
...
def main():
    ...
    parser.add_argument("--table", type=str, default="market_data", help="Table name")
    parser.add_argument(
    ...
    if args.action == "validate":
        ...
        test_data = {"open": 100, "high": 105, "low": 98, "close": 102, "volume": 10000}
