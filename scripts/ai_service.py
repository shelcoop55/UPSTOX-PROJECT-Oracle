...
class AIService:
    ...
    def __init__(self):
        ...
        if not self.clients:
            logger.warning("No AI providers configured (Groq/OpenRouter). AI features will fail.")
    ...
    def get_market_movers(self, category: str = "NSE_MAIN") -> Dict[str, Any]:
        ...
        category_map = {
            "NSE": "NSE_MAIN", "BSE": "BSE_MAIN", 
            "NIFTY": "NIFTY_50", "BANKNIFTY": "NIFTY_BANK"
        }
    ...
    def get_stock_quote(self, symbol: str) -> Dict[str, Any]:
        ...
        try:
             ...
             if isinstance(search_res, list) and len(search_res) > 0 and 'instrument_key' in search_res[0]:
                 target = search_res[0]
                 ...
                 if resp.status_code == 200:
                     return {"symbol": name, "key": key, "data": resp.json().get('data', {})}
