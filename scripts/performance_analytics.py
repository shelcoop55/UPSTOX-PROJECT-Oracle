...
class PerformanceAnalytics:
    ...
    def get_profit_factor(self, days: Optional[int] = None) -> Dict[str, Any]:
        ...
        if not pnls:
            return {"profit_factor": 0, "avg_win": 0, "avg_loss": 0, "total_pnl": 0}
    ...
    def calculate_sharpe_ratio(
        self, days: int = 30, risk_free_rate: float = 0.05
    ) -> float:
            ...
            equity_curve.append(
                {
                    ...
                    "pnl": daily_pnl,
                    "return_pct": (
                        (current_equity - starting_capital) / starting_capital
                    )
                    * 100,
                }
            )
