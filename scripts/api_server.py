...
from scripts.legacy.order_manager_v3 import OrderManagerV3 as OrderManager
...
from scripts.backtesting_engine import Backtester, BacktestStrategy, create_iron_condor, create_bull_call_spread
...
from scripts.metrics.portfolio_analytics import PortfolioAnalytics
...
from scripts.legacy.multi_expiry_strategies import (
...
def roll_expiry():
    ...
    try:
        ...
        # Create current leg
        from scripts.legacy.multi_expiry_strategies import MultiExpiryLeg, OptionType, ActionType
