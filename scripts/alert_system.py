...
class AlertSystem:
    ...
    def add_volume_spike_alert(
        self, symbol: str, multiplier: float = 2.0, priority: str = AlertPriority.HIGH
    ) -> int:
    ...
    def add_percentage_change_alert(
        self, symbol: str, percentage: float, priority: str = AlertPriority.MEDIUM
    ) -> int:
