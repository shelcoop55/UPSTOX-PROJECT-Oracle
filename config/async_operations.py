...
async def fetch_multiple_urls(urls: List[str], timeout: int = 10) -> List[Dict[str, Any]]:
    """
...
async def fetch_market_data_async(symbols: List[str], api_base: str) -> Dict[str, Any]:
    ...
    logger.info(f"Fetched {market_data['successful']}/{len(symbols)} symbols in {market_data['fetch_time_ms']:.2f}ms")
