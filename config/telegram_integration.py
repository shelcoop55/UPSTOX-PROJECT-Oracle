...
class TelegramNotifier:
    ...
    def __init__(self):
        ...
        if not self.enabled:
            logger.warning("Telegram bot not configured (TELEGRAM_BOT_TOKEN or TELEGRAM_CHAT_ID missing)")
        else:
    ...
    def send_alert(self, alert_type: str, message: str, data: Optional[Dict[str, Any]] = None) -> bool:
        """
...
"""
    ...
    def send_price_alert(self, symbol: str, price: float, condition: str, threshold: float) -> bool:
        """Send price alert"""
        message = f"""
...
"""
    ...
    def send_order_notification(self, order_id: str, symbol: str, action: str, 
                                quantity: int, price: float, status: str) -> bool:
...
"""
    ...
    def send_news_alert(self, title: str, summary: str, url: Optional[str] = None) -> bool:
        """Send news alert"""
        message = f"""
📰 <b>Market News</b>
...
"""
    ...
    def send_strategy_signal(self, symbol: str, signal: str, strategy: str, 
                            confidence: float, entry_price: float) -> bool:
...
def send_telegram_alert(alert_type: str, message: str, data: Optional[Dict] = None) -> bool:
    """
...
if __name__ == '__main__':
    ...
    if notifier.enabled:
        ...
        success = notifier.send_message("✅ <b>Test Alert</b>\n\nTelegram integration is working!")
